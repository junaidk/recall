...
func MustLoadTemplates() *Templates {
	...
	pages := []string{"login.html", "register.html", "decks.html", "review.html", "stats.html"}
	...
	partials := []string{"_card_front.html", "_card_back.html", "_done.html", "_example_block.html", "_example_choices.html", "_conjugations_block.html"}
